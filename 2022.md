...
<details>
  ...
  参与黑客松的朋友们在教室内自我介绍，并可以介绍自己常用的一个包并介绍其一个或多个函待解决的一个Github 赏金issue。比如我是Julia软件包 Yao.jl 的老用户，上午自我介绍的时候我介绍量子模拟软件Yao，并指定里面的<a href="https://github.com/QuantumBFS/Yao.jl/issues/382">382号issue</a>为奖金issue。
</details>
<details>
...
<li>
<strong>12月8日 星期四 (科学应用之夜)</strong>
</li>
<li>
<strong>12月9日 星期五 (工业应用之夜)</strong>
</li>
</ul>
~~~
